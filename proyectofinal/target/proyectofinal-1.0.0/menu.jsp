...
<body>
    ...
    <section class="about">
        <div class="about-content container">
            <div class="about-txt">
                ...
                <h2>Tu refugio de estilo y distinción. Siéntete como en casa, caballero.</h2>
                <hr>
            </div>
            <div class="about-img">
    ...
    <footer class="footer">
        <div class="footer-content container">
            <div class="link">
                <ul>
                    <li><a href="#">Encuéntranos en Facebook</a></li>
                </ul>
            </div>
            <div class="link">
                <ul>
                    <li><a href="#">Encuéntranos en Instagram</a></li>
                </ul>
            </div>
            <div class="link">
                <ul>
                    <li><a href="#">Escríbenos a nuestro WhatsApp</a></li>
                </ul>
            </div>
        </div>
    </footer>
